...
function show_nuevo_form(){
      $("#modal_nuevo_form").modal('show');
      document.f_nuevo_form.referencia.focus();
   }
...
$(document).ready(function () {
    ...
    $(".clickableRow").mousedown(function (event) {
        if (event.which === 1) {
            ...
            if (typeof href !== typeof undefined && href !== false) {
                ...
                window.open($(this).attr("href"),'testIframe');
                /*
    ...
    $("#b_nuevo_form").click(function (event) {
            event.preventDefault();
            show_nuevo_form();
        });
});
