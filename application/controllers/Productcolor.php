...
class Productcolor extends MY_Controller {

    private $data;
    private $APPNAME = 'Colores Productos';
    public function __construct() {
        parent::__construct();
        $this->load->model('db/xdb');
        $this->xdb->set_tablename('dt_productpaint');
        $this->xdb->set_keyfield('productpaint_id');
    ...
    public function index() {
        ...
        $this->_render(_PATH.'/'._PATHC, $this->data);
    }
