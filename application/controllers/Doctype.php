...
class Doctype extends MY_Controller {

    private $data;
    private $APPNAME = 'Tipo de Documento [TDC]';

    public function __construct() {
        parent::__construct();
        $this->xdb->set_tablename('dt_doctype');
        $this->xdb->set_keyfield('doctype_id');
        // No modificar debajo de esta linea
        $this->data['APPNAME'] = $this->APPNAME;
        define('_PATH', 'doctype');
