...
<header id="header">
    ...
    <span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">Si ya estas registrado?</span> 
        <a href="<?php echo base_url(); ?>" class="btn btn-primary">
            <span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> LOGIN</a> </span>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                <div class="well no-padding">
                    ...
                    <form action="http://192.241.236.31/themes/preview/smartadmin/1.9.x/ajax/php/demo-register.php" id="smart-form-register" class="smart-form client-form">
                        <header>
                            Registros de nuevo usuario
                        </header>
